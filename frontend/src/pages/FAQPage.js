...
const FAQPage = () => {
    ...
    const faqs = [
            ...
            answer: (
                <>
                    ...
                    <ol>
                        ...
                        <li>You can send us a message through the contact form or email us directly at <a href="mailto:ramanbansal2004@gmail.com">ramanbansal2004@gmail.com</a>.</li>
                    </ol>
                </>
            )
        },
        {
            ...
            answer: (
                <>
                    <p>Admins are usually invited by the platform owner. If you're interested in becoming an admin, please contact us at <a href="mailto:ramanbansal2004@gmail.com">ramanbansal2004@gmail.com   </a>.</p>
